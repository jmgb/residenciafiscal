...
FIXTURE_PATH = PROJECT_ROOT / "test" / "fixtures" / "jurisprudence_case_v3" / "valid_minimal.json"
INVALID_FIXTURE_PATH = (
    PROJECT_ROOT / "test" / "fixtures" / "jurisprudence_case_v3" / "invalid_missing_reference.json"
)

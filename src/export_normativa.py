...
`docs/normativa/NORMATIVA.md`.

    uv run python src/export_normativa.py --jurisdiccion es
"""
...
def main() -> int:
    ...
    if args.jurisdiccion not in JURISDICCIONES:
        print(
            ...
            "Añadir una nueva requiere su lector de fuentes; ver docs/normativa/NORMATIVA.md."
        )
        return 1

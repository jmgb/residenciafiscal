...
Usage:
    python tests/test_reasoning_effort_comparison.py [--pdf PATH]

Examples:
    # Test with default PDF
    python tests/test_reasoning_effort_comparison.py

    # Test with specific PDF
    python tests/test_reasoning_effort_comparison.py --pdf sentencias/STS_4220_2024.pdf
"""
...
async def run_single_test(
    ...
    cmd = [
        sys.executable,
        str(PROJECT_ROOT / "src" / "residenciafiscal.py"),
        "--input",
        str(pdf_path.parent),
        "--output",
        str(output_subdir),

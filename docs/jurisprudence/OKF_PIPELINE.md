...
uv run python src/export_okf.py \
...
| `tests/test_okf_normalization.py` | Contrato del perfil y render |
| `tests/test_okf_annotations.py` | Inmutabilidad y contrato de sidecars |
| `tests/test_okf_bundle.py` | Ciclo integral, determinismo y bundle versionado |

...
| Producto | [Arquitectura internacional y posts de sentencias](product/INTERNATIONAL_ARCHITECTURE.md), [páginas de país](product/COUNTRY_PAGES.md), [analítica](product/ANALYTICS.md), [auditoría SEO](product/SEO_AUDIT.md), [API/MCP para agentes con créditos prepagados](product/AGENT_API_MCP.md) |

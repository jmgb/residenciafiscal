...
| Infraestructura | [Despliegue del chat](operations/CHAT_DEPLOYMENT.md), [plan propuesto de migración a Alfredo](project/CHAT_ALFREDO_MIGRATION_PLAN.md), [persistencia Supabase](operations/SUPABASE_CHAT.md), [observabilidad del chat](operations/CHAT_OBSERVABILITY.md), [autofix de Sentry](operations/AUTOFIX.md), [backups](operations/BACKUPS.md), [Netlify](operations/NETLIFY.md), [Netlify Edge](operations/NETLIFY_EDGE.md), [Cloudflare](operations/CLOUDFLARE.md), [UptimeRobot](operations/UPTIMEROBOT.md), [informe semanal de tráfico](operations/WEEKLY_TRAFFIC_REPORT.md), [diseño histórico del backend del chat](development/CHAT_BACKEND_DESIGN.md) |
